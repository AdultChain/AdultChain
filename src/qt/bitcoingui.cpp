                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("AdultChain Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a AdultChain address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and adultchain: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zXXX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About AdultChain Core"), this);
    aboutAction->setStatusTip(tr("Show information about AdultChain Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for AdultChain"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your AdultChain addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified AdultChain addresses"));
    ...
    openAction->setStatusTip(tr("Open a AdultChain: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the AdultChain Core help message to get a list with possible AdultChain command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("AdultChain Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to AdultChain network", "", count));
}
...
{
    QString strTitle = tr("AdultChain Core"); // default title
