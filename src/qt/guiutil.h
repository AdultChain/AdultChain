...
/** Utility functions used by the AdultChain Qt UI.
 */
namespace GUIUtil
{
...
// Render AdultChain addresses in monospace font
...
// Parse "adultchain:" URI into recipient object, return true on successful parsing
