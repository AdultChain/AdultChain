...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/adultchain-cli.cpp \
           src/adultchain-tx.cpp \
           src/adultchain.cpp \
           src/db.cpp \
           ...
           src/qt/adultchain.cpp \
           src/qt/adultchainstrings.cpp \
...
RESOURCES += src/qt/adultchain.qrc src/qt/adultchain_locale.qrc

TRANSLATIONS += src/qt/locale/adultchain_bg.ts \
                src/qt/locale/adultchain_de.ts \
                src/qt/locale/adultchain_en.ts \
                src/qt/locale/adultchain_es.ts \
                src/qt/locale/adultchain_fi.ts \
                src/qt/locale/adultchain_fr.ts \
                src/qt/locale/adultchain_it.ts \
                src/qt/locale/adultchain_ja.ts \
                src/qt/locale/adultchain_pl.ts \
                src/qt/locale/adultchain_pt.ts \
                src/qt/locale/adultchain_ru.ts \
                src/qt/locale/adultchain_sk.ts \
                src/qt/locale/adultchain_sv.ts \
                src/qt/locale/adultchain_vi.ts \
                src/qt/locale/adultchain_zh_CN.ts \
                src/qt/locale/adultchain_zh_TW.ts
