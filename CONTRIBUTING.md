Contributing to AdultChain Core
============================

The AdultChain Core project operates an open contributor model where anyone is
...
The following applies to code changes to the AdultChain Core project, and is not to be
confused with overall AdultChain Network Protocol consensus changes.

Whether a pull request is merged into AdultChain Core rests with the project merge
...
Patches that change AdultChain consensus rules are considerably more involved than
...
Where a patch set proposes to change the AdultChain consensus, it must have been
...
The project leader is the release manager for each AdultChain Core release.
