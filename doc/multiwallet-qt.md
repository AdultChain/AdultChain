...
In order to support loading of multiple wallets in adultchain-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is adultchain.cpp.
...
Changes to adultchain.cpp
----------------------
adultchain.cpp is the entry point into adultchain-qt, and as such, will require some minor modifications to provide hooks for
